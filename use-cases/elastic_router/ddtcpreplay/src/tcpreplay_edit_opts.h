...
typedef enum {
    ...
    INDEX_OPT_UNIQUE_IP        = 52,
    INDEX_OPT_NETMAP           = 53,
    INDEX_OPT_NM_DELAY         = 54,
    INDEX_OPT_NO_FLOW_STATS    = 55,
    INDEX_OPT_FLOW_EXPIRY      = 56,
    INDEX_OPT_PID              = 57,
    INDEX_OPT_QUICK_TX         = 58,
    INDEX_OPT_STATS            = 59,
    INDEX_OPT_VERSION          = 60,
    INDEX_OPT_LESS_HELP        = 61,
    INDEX_OPT_HELP             = 62,
    INDEX_OPT_MORE_HELP        = 63,
    INDEX_OPT_SAVE_OPTS        = 64,
    INDEX_OPT_LOAD_OPTS        = 65
} teOptIndex;
...
#define VALUE_OPT_MAXSLEEP       0x1012
...
#define VALUE_OPT_PPS_MULTI      0x1017

#define OPT_VALUE_PPS_MULTI      (DESC(PPS_MULTI).optArg.argInt)
#define VALUE_OPT_UNIQUE_IP      0x1018
#define VALUE_OPT_NETMAP         0x1019
#define VALUE_OPT_NM_DELAY       0x101A
#ifdef HAVE_NETMAP
#define OPT_VALUE_NM_DELAY       (DESC(NM_DELAY).optArg.argInt)
#endif /* HAVE_NETMAP */
#define VALUE_OPT_NO_FLOW_STATS  0x101B
#define VALUE_OPT_FLOW_EXPIRY    0x101C

#define OPT_VALUE_FLOW_EXPIRY    (DESC(FLOW_EXPIRY).optArg.argInt)
#define VALUE_OPT_PID            'P'
#define VALUE_OPT_QUICK_TX       0x101D
#define VALUE_OPT_STATS          0x101E
...
#define VALUE_OPT_SAVE_OPTS     0x101F
/** option flag (value) for load-opts-value option */
#define VALUE_OPT_LOAD_OPTS     0x1020
