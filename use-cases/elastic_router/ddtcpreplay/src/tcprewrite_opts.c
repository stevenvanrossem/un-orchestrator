 ...
 */
static char const tcprewrite_opt_strs[4512] =
...
/*  2581 */ "DBUG\0"
/*  2586 */ "dbug\0"
/*  2591 */ "Input pcap file to be processed\0"
/*  2623 */ "INFILE\0"
/*  2630 */ "infile\0"
/*  2637 */ "Output pcap file\0"
/*  2654 */ "OUTFILE\0"
/*  2662 */ "outfile\0"
/*  2670 */ "Split traffic via tcpprep cache file\0"
/*  2707 */ "CACHEFILE\0"
/*  2717 */ "cachefile\0"
/*  2727 */ "Print decoded packets via tcpdump to STDOUT\0"
/*  2771 */ "VERBOSE\0"
/*  2779 */ "verbose\0"
/*  2787 */ "Arguments passed to tcpdump decoder\0"
/*  2823 */ "DECODE\0"
/*  2830 */ "decode\0"
/*  2837 */ "Parse fragroute configuration file\0"
/*  2872 */ "FRAGROUTE\0"
/*  2882 */ "fragroute\0"
/*  2892 */ "Which flows to apply fragroute to: c2s, s2c, both\0"
/*  2942 */ "FRAGDIR\0"
/*  2950 */ "fragdir\0"
/*  2958 */ "Skip writing packets with soft errors\0"
/*  2996 */ "SKIP_SOFT_ERRORS\0"
/*  3013 */ "skip-soft-errors\0"
/*  3030 */ "Print version information\0"
/*  3056 */ "VERSION\0"
/*  3064 */ "version\0"
/*  3072 */ "Display less usage information and exit\0"
/*  3112 */ "LESS_HELP\0"
/*  3122 */ "less-help\0"
/*  3132 */ "display extended usage information and exit\0"
/*  3176 */ "help\0"
/*  3181 */ "extended usage information passed thru pager\0"
/*  3226 */ "more-help\0"
/*  3236 */ "save the option state to a config file\0"
/*  3275 */ "save-opts\0"
/*  3285 */ "load options from a config file\0"
/*  3317 */ "LOAD_OPTS\0"
/*  3327 */ "no-load-opts\0"
/*  3340 */ "no\0"
/*  3343 */ "TCPREWRITE\0"
/*  3354 */ "tcprewrite (tcprewrite) - Rewrite the packets in a pcap file.\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  3474 */ "$$/\0"
/*  3478 */ ".tcprewriterc\0"
/*  3492 */ "tcpreplay-users@lists.sourceforge.net\0"
/*  3530 */ "Tcprewrite is a tool to rewrite packets stored in 'pcap(3)' file format,\n"
...
#define SKIPBROADCAST_DESC      (tcprewrite_opt_strs+1257)
/** Upper-cased name for the skipbroadcast option */
#define SKIPBROADCAST_NAME      (tcprewrite_opt_strs+1310)
/** Name string for the skipbroadcast option */
#define SKIPBROADCAST_name      (tcprewrite_opt_strs+1324)
...
#define FIXCSUM_DESC      (tcprewrite_opt_strs+1338)
/** Upper-cased name for the fixcsum option */
#define FIXCSUM_NAME      (tcprewrite_opt_strs+1391)
/** Name string for the fixcsum option */
#define FIXCSUM_name      (tcprewrite_opt_strs+1399)
...
#define MTU_DESC      (tcprewrite_opt_strs+1407)
/** Upper-cased name for the mtu option */
#define MTU_NAME      (tcprewrite_opt_strs+1448)
...
#define MTU_TRUNC_DESC      (tcprewrite_opt_strs+1456)
/** Upper-cased name for the mtu-trunc option */
#define MTU_TRUNC_NAME      (tcprewrite_opt_strs+1499)
/** Name string for the mtu-trunc option */
#define MTU_TRUNC_name      (tcprewrite_opt_strs+1509)
...
#define EFCS_DESC      (tcprewrite_opt_strs+1519)
/** Upper-cased name for the efcs option */
#define EFCS_NAME      (tcprewrite_opt_strs+1570)
/** Name string for the efcs option */
#define EFCS_name      (tcprewrite_opt_strs+1575)
...
#define TTL_DESC      (tcprewrite_opt_strs+1580)
/** Upper-cased name for the ttl option */
#define TTL_NAME      (tcprewrite_opt_strs+1613)
...
#define TOS_DESC      (tcprewrite_opt_strs+1621)
/** Upper-cased name for the tos option */
#define TOS_NAME      (tcprewrite_opt_strs+1656)
...
#define TCLASS_DESC      (tcprewrite_opt_strs+1664)
/** Upper-cased name for the tclass option */
#define TCLASS_NAME      (tcprewrite_opt_strs+1696)
/** Name string for the tclass option */
#define TCLASS_name      (tcprewrite_opt_strs+1703)
...
#define FLOWLABEL_DESC      (tcprewrite_opt_strs+1710)
/** Upper-cased name for the flowlabel option */
#define FLOWLABEL_NAME      (tcprewrite_opt_strs+1734)
/** Name string for the flowlabel option */
#define FLOWLABEL_name      (tcprewrite_opt_strs+1744)
...
#define FIXLEN_DESC      (tcprewrite_opt_strs+1754)
/** Upper-cased name for the fixlen option */
#define FIXLEN_NAME      (tcprewrite_opt_strs+1805)
/** Name string for the fixlen option */
#define FIXLEN_name      (tcprewrite_opt_strs+1812)
...
#define SKIPL2BROADCAST_DESC      (tcprewrite_opt_strs+1819)
/** Upper-cased name for the skipl2broadcast option */
#define SKIPL2BROADCAST_NAME      (tcprewrite_opt_strs+1872)
/** Name string for the skipl2broadcast option */
#define SKIPL2BROADCAST_name      (tcprewrite_opt_strs+1888)
...
#define DLT_DESC      (tcprewrite_opt_strs+1904)
/** Upper-cased name for the dlt option */
#define DLT_NAME      (tcprewrite_opt_strs+1938)
...
#define ENET_DMAC_DESC      (tcprewrite_opt_strs+1946)
/** Upper-cased name for the enet-dmac option */
#define ENET_DMAC_NAME      (tcprewrite_opt_strs+1990)
/** Name string for the enet-dmac option */
#define ENET_DMAC_name      (tcprewrite_opt_strs+2000)
...
#define ENET_SMAC_DESC      (tcprewrite_opt_strs+2010)
/** Upper-cased name for the enet-smac option */
#define ENET_SMAC_NAME      (tcprewrite_opt_strs+2049)
/** Name string for the enet-smac option */
#define ENET_SMAC_name      (tcprewrite_opt_strs+2059)
...
#define ENET_VLAN_DESC      (tcprewrite_opt_strs+2069)
/** Upper-cased name for the enet-vlan option */
#define ENET_VLAN_NAME      (tcprewrite_opt_strs+2107)
/** Name string for the enet-vlan option */
#define ENET_VLAN_name      (tcprewrite_opt_strs+2117)
...
#define ENET_VLAN_TAG_DESC      (tcprewrite_opt_strs+2127)
/** Upper-cased name for the enet-vlan-tag option */
#define ENET_VLAN_TAG_NAME      (tcprewrite_opt_strs+2174)
/** Name string for the enet-vlan-tag option */
#define ENET_VLAN_TAG_name      (tcprewrite_opt_strs+2188)
...
#define ENET_VLAN_CFI_DESC      (tcprewrite_opt_strs+2202)
/** Upper-cased name for the enet-vlan-cfi option */
#define ENET_VLAN_CFI_NAME      (tcprewrite_opt_strs+2245)
/** Name string for the enet-vlan-cfi option */
#define ENET_VLAN_CFI_name      (tcprewrite_opt_strs+2259)
...
#define ENET_VLAN_PRI_DESC      (tcprewrite_opt_strs+2273)
/** Upper-cased name for the enet-vlan-pri option */
#define ENET_VLAN_PRI_NAME      (tcprewrite_opt_strs+2315)
/** Name string for the enet-vlan-pri option */
#define ENET_VLAN_PRI_name      (tcprewrite_opt_strs+2329)
...
#define HDLC_CONTROL_DESC      (tcprewrite_opt_strs+2343)
...
#define HDLC_CONTROL_name      (tcprewrite_opt_strs+2383)
...
#define HDLC_ADDRESS_DESC      (tcprewrite_opt_strs+2396)
...
#define HDLC_ADDRESS_name      (tcprewrite_opt_strs+2430)
...
#define USER_DLT_DESC      (tcprewrite_opt_strs+2443)
/** Upper-cased name for the user-dlt option */
#define USER_DLT_NAME      (tcprewrite_opt_strs+2468)
/** Name string for the user-dlt option */
#define USER_DLT_name      (tcprewrite_opt_strs+2477)
...
#define USER_DLINK_DESC      (tcprewrite_opt_strs+2486)
/** Upper-cased name for the user-dlink option */
#define USER_DLINK_NAME      (tcprewrite_opt_strs+2535)
/** Name string for the user-dlink option */
#define USER_DLINK_name      (tcprewrite_opt_strs+2546)
...
#define DBUG_DESC      (tcprewrite_opt_strs+2557)
/** Upper-cased name for the dbug option */
#define DBUG_NAME      (tcprewrite_opt_strs+2581)
/** Name string for the dbug option */
#define DBUG_name      (tcprewrite_opt_strs+2586)
...
#define INFILE_DESC      (tcprewrite_opt_strs+2591)
/** Upper-cased name for the infile option */
#define INFILE_NAME      (tcprewrite_opt_strs+2623)
/** Name string for the infile option */
#define INFILE_name      (tcprewrite_opt_strs+2630)
...
#define OUTFILE_DESC      (tcprewrite_opt_strs+2637)
/** Upper-cased name for the outfile option */
#define OUTFILE_NAME      (tcprewrite_opt_strs+2654)
/** Name string for the outfile option */
#define OUTFILE_name      (tcprewrite_opt_strs+2662)
...
#define CACHEFILE_DESC      (tcprewrite_opt_strs+2670)
/** Upper-cased name for the cachefile option */
#define CACHEFILE_NAME      (tcprewrite_opt_strs+2707)
/** Name string for the cachefile option */
#define CACHEFILE_name      (tcprewrite_opt_strs+2717)
...
#define VERBOSE_DESC      (tcprewrite_opt_strs+2727)
/** Upper-cased name for the verbose option */
#define VERBOSE_NAME      (tcprewrite_opt_strs+2771)
/** Name string for the verbose option */
#define VERBOSE_name      (tcprewrite_opt_strs+2779)
...
#define DECODE_DESC      (tcprewrite_opt_strs+2787)
/** Upper-cased name for the decode option */
#define DECODE_NAME      (tcprewrite_opt_strs+2823)
/** Name string for the decode option */
#define DECODE_name      (tcprewrite_opt_strs+2830)
...
#define FRAGROUTE_DESC      (tcprewrite_opt_strs+2837)
/** Upper-cased name for the fragroute option */
#define FRAGROUTE_NAME      (tcprewrite_opt_strs+2872)
/** Name string for the fragroute option */
#define FRAGROUTE_name      (tcprewrite_opt_strs+2882)
...
#define FRAGDIR_DESC      (tcprewrite_opt_strs+2892)
/** Upper-cased name for the fragdir option */
#define FRAGDIR_NAME      (tcprewrite_opt_strs+2942)
/** Name string for the fragdir option */
#define FRAGDIR_name      (tcprewrite_opt_strs+2950)
...
#define SKIP_SOFT_ERRORS_DESC      (tcprewrite_opt_strs+2958)
/** Upper-cased name for the skip-soft-errors option */
#define SKIP_SOFT_ERRORS_NAME      (tcprewrite_opt_strs+2996)
/** Name string for the skip-soft-errors option */
#define SKIP_SOFT_ERRORS_name      (tcprewrite_opt_strs+3013)
...
#define VERSION_DESC      (tcprewrite_opt_strs+3030)
/** Upper-cased name for the version option */
#define VERSION_NAME      (tcprewrite_opt_strs+3056)
/** Name string for the version option */
#define VERSION_name      (tcprewrite_opt_strs+3064)
...
#define LESS_HELP_DESC      (tcprewrite_opt_strs+3072)
/** Upper-cased name for the less-help option */
#define LESS_HELP_NAME      (tcprewrite_opt_strs+3112)
/** Name string for the less-help option */
#define LESS_HELP_name      (tcprewrite_opt_strs+3122)
 ...
 */
#define HELP_DESC       (tcprewrite_opt_strs+3132)
#define HELP_name       (tcprewrite_opt_strs+3176)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (tcprewrite_opt_strs+3181)
#define MORE_HELP_name  (tcprewrite_opt_strs+3226)
...
#endif
#define SAVE_OPTS_DESC  (tcprewrite_opt_strs+3236)
#define SAVE_OPTS_name  (tcprewrite_opt_strs+3275)
#define LOAD_OPTS_DESC     (tcprewrite_opt_strs+3285)
#define LOAD_OPTS_NAME     (tcprewrite_opt_strs+3317)
#define NO_LOAD_OPTS_name  (tcprewrite_opt_strs+3327)
#define LOAD_OPTS_pfx      (tcprewrite_opt_strs+3340)
