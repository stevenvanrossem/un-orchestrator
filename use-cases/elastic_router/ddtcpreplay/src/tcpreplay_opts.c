 ...
 */
static char const tcpreplay_opt_strs[3850] =
...
/*  2266 */ "UNIQUE_IP\0"
/*  2276 */ "unique-ip\0"
/*  2286 */ "Write packets directly to netmap enabled network adapter\0"
/*  2343 */ "NETMAP\0"
/*  2350 */ "netmap\0"
/*  2357 */ "Netmap startup delay\0"
/*  2378 */ "NM_DELAY\0"
/*  2387 */ "nm-delay\0"
/*  2396 */ "Suppress printing and tracking flow count, rates and expirations\0"
/*  2461 */ "NO_FLOW_STATS\0"
/*  2475 */ "no-flow-stats\0"
/*  2489 */ "Number of inactive seconds before a flow is considered expired\0"
/*  2552 */ "FLOW_EXPIRY\0"
/*  2564 */ "flow-expiry\0"
/*  2576 */ "Print the PID of tcpreplay at startup\0"
/*  2614 */ "PID\0"
/*  2618 */ "pid\0"
/*  2622 */ "Write packets directly to an interface via Quick_TX module\0"
/*  2681 */ "QUICK_TX\0"
/*  2690 */ "quick-tx\0"
/*  2699 */ "Print statistics every X seconds\0"
/*  2732 */ "STATS\0"
/*  2738 */ "stats\0"
/*  2744 */ "Print version information\0"
/*  2770 */ "VERSION\0"
/*  2778 */ "version\0"
/*  2786 */ "Display less usage information and exit\0"
/*  2826 */ "LESS_HELP\0"
/*  2836 */ "less-help\0"
/*  2846 */ "display extended usage information and exit\0"
/*  2890 */ "help\0"
/*  2895 */ "extended usage information passed thru pager\0"
/*  2940 */ "more-help\0"
/*  2950 */ "save the option state to a config file\0"
/*  2989 */ "save-opts\0"
/*  2999 */ "load options from a config file\0"
/*  3031 */ "LOAD_OPTS\0"
/*  3041 */ "no-load-opts\0"
/*  3054 */ "no\0"
/*  3057 */ "TCPREPLAY\0"
/*  3067 */ "tcpreplay (tcpreplay) - Replay network traffic stored in pcap files\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... <pcap_file(s)>\n\0"
/*  3208 */ "$$/\0"
/*  3212 */ ".tcpreplayrc\0"
/*  3225 */ "tcpreplay-users@lists.sourceforge.net\0"
/*  3263 */ "tcpreplay is a tool for replaying network traffic from files saved with\n"
            "tcpdump or other tools which write pcap(3) files.\n\0"
/*  3386 */ "The basic operation of tcpreplay is to resend all packets from the input\n"
...
#define NETMAP_DESC      (tcpreplay_opt_strs+2286)
/** Upper-cased name for the netmap option */
#define NETMAP_NAME      (tcpreplay_opt_strs+2343)
/** Name string for the netmap option */
#define NETMAP_name      (tcpreplay_opt_strs+2350)
...
#define NM_DELAY_DESC      (tcpreplay_opt_strs+2357)
/** Upper-cased name for the nm-delay option */
#define NM_DELAY_NAME      (tcpreplay_opt_strs+2378)
/** Name string for the nm-delay option */
#define NM_DELAY_name      (tcpreplay_opt_strs+2387)
...
#define NO_FLOW_STATS_DESC      (tcpreplay_opt_strs+2396)
/** Upper-cased name for the no-flow-stats option */
#define NO_FLOW_STATS_NAME      (tcpreplay_opt_strs+2461)
/** Name string for the no-flow-stats option */
#define NO_FLOW_STATS_name      (tcpreplay_opt_strs+2475)
...
#define FLOW_EXPIRY_DESC      (tcpreplay_opt_strs+2489)
/** Upper-cased name for the flow-expiry option */
#define FLOW_EXPIRY_NAME      (tcpreplay_opt_strs+2552)
/** Name string for the flow-expiry option */
#define FLOW_EXPIRY_name      (tcpreplay_opt_strs+2564)
...
#define PID_DESC      (tcpreplay_opt_strs+2576)
/** Upper-cased name for the pid option */
#define PID_NAME      (tcpreplay_opt_strs+2614)
/** Name string for the pid option */
#define PID_name      (tcpreplay_opt_strs+2618)
...
#define QUICK_TX_DESC      (tcpreplay_opt_strs+2622)
/** Upper-cased name for the quick-tx option */
#define QUICK_TX_NAME      (tcpreplay_opt_strs+2681)
/** Name string for the quick-tx option */
#define QUICK_TX_name      (tcpreplay_opt_strs+2690)
...
#define STATS_DESC      (tcpreplay_opt_strs+2699)
/** Upper-cased name for the stats option */
#define STATS_NAME      (tcpreplay_opt_strs+2732)
/** Name string for the stats option */
#define STATS_name      (tcpreplay_opt_strs+2738)
...
#define VERSION_DESC      (tcpreplay_opt_strs+2744)
/** Upper-cased name for the version option */
#define VERSION_NAME      (tcpreplay_opt_strs+2770)
/** Name string for the version option */
#define VERSION_name      (tcpreplay_opt_strs+2778)
...
#define LESS_HELP_DESC      (tcpreplay_opt_strs+2786)
/** Upper-cased name for the less-help option */
#define LESS_HELP_NAME      (tcpreplay_opt_strs+2826)
/** Name string for the less-help option */
#define LESS_HELP_name      (tcpreplay_opt_strs+2836)
 ...
 */
#define HELP_DESC       (tcpreplay_opt_strs+2846)
#define HELP_name       (tcpreplay_opt_strs+2890)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (tcpreplay_opt_strs+2895)
#define MORE_HELP_name  (tcpreplay_opt_strs+2940)
...
#endif
#define SAVE_OPTS_DESC  (tcpreplay_opt_strs+2950)
#define SAVE_OPTS_name  (tcpreplay_opt_strs+2989)
#define LOAD_OPTS_DESC     (tcpreplay_opt_strs+2999)
#define LOAD_OPTS_NAME     (tcpreplay_opt_strs+3031)
#define NO_LOAD_OPTS_name  (tcpreplay_opt_strs+3041)
#define LOAD_OPTS_pfx      (tcpreplay_opt_strs+3054)
...
static tOptDesc optDesc[OPTION_CT] = {
  ...
  {  /* entry idx, value */ 24, VALUE_OPT_NETMAP,
     /* equiv idx, value */ 24, VALUE_OPT_NETMAP,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 25, VALUE_OPT_NM_DELAY,
     /* equiv idx, value */ 25, VALUE_OPT_NM_DELAY,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 26, VALUE_OPT_NO_FLOW_STATS,
     /* equiv idx, value */ 26, VALUE_OPT_NO_FLOW_STATS,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 27, VALUE_OPT_FLOW_EXPIRY,
     /* equiv idx, value */ 27, VALUE_OPT_FLOW_EXPIRY,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
