...
typedef enum {
    ...
    INDEX_OPT_NETMAP         = 24,
    INDEX_OPT_NM_DELAY       = 25,
    INDEX_OPT_NO_FLOW_STATS  = 26,
    INDEX_OPT_FLOW_EXPIRY    = 27,
    INDEX_OPT_PID            = 28,
...
#define VALUE_OPT_NETMAP         0x1008
#define VALUE_OPT_NM_DELAY       0x1009
#ifdef HAVE_NETMAP
#define OPT_VALUE_NM_DELAY       (DESC(NM_DELAY).optArg.argInt)
#endif /* HAVE_NETMAP */
#define VALUE_OPT_NO_FLOW_STATS  0x100A
#define VALUE_OPT_FLOW_EXPIRY    0x100B

#define OPT_VALUE_FLOW_EXPIRY    (DESC(FLOW_EXPIRY).optArg.argInt)
#define VALUE_OPT_PID            'P'
#define VALUE_OPT_QUICK_TX       0x100C
