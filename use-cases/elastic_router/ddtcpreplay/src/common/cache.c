...
read_cache(char **cachedata, const char *cachefile, char **comment)
{
    ...
    *comment = (char *)tcpr_safe_malloc(header.comment_len + 1);
    ...
    *cachedata = (char *)tcpr_safe_malloc(cache_size);
    ...
    char *comment)
{
    ...
    cache_header = (tcpr_cache_file_hdr_t *)
        tcpr_safe_malloc(sizeof(tcpr_cache_file_hdr_t));
...
new_cache(void)
{
    ...
    /* malloc mem */
    newcache = (tcpr_cache_t *)tcpr_safe_malloc(sizeof(tcpr_cache_t));
    return (newcache);
}
